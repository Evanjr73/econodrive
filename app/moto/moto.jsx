        ...
        <View style={styles.body}>
            {!showButton ? (
                <View style={styles.containerSimples}>
                    <Image source={require("../../assets/images/EconoDriveMoto.png")} style={styles.logoG} resizeMode="contain"/>
                    <Animated.View
                        style={{
                            height: 50,
                            width: largura,
                ...
                <View style={styles.containerSimplesOut}>
                    ...
                    <View style={{
                        ...
                        <Image source={require("../../assets/images/EconoDriveMoto.png")} style={styles.logoM} resizeMode="contain" />
