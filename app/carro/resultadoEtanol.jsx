                ...
                <View style={styles.containerSimplesOut}>
                    ...
                    <View style={{
                        ...
                        <View style={stylesButtons.CarroMoto}>
                            <Text style={{ fontSize: 25 }}> R${consumo}</Text>
                        </View>
                    ...
                    <View style={{
                        ...
                        <Image source={require("../../assets/images/EconoDrive.png")} style={styles.logoM} resizeMode="contain"/>
                        <Text style={{ fontSize: 20, marginBottom: 10 , fontFamily:'Inter-Black'}}> VALOR DO LITRO DO ETANOL</Text>
                        <TextInput
                        ...
                        <Text style={{ fontSize: 20, marginBottom: 10, fontFamily:'Inter-Black' }}> QUILOMETOR POR LITRO DE ETANOL</Text>
                        <TextInput
                            style={stylesButtons.CarroMoto}
                            placeholder="10 KM/L"
                            keyboardType="numeric"
