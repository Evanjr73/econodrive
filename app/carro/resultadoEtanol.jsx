...
export default function Resultadocarroetanol() {
                ...
                <View style={styles.containerSimplesOut}>
                    ...
                    <View style={
                        ...
                        <Image
                            ...
                            resizeMode="contain"
                        />
                        <Text style={{ fontSize: 25 }}> VALOR DE COMBUSTIVEL</Text>
                        <View style={stylesButtons.CarroMoto}>

                            <Text style={{ fontSize: 25 }}> R${consumo.toFixed(2)}</Text>
                        </View>

                        <Text style={{ fontSize: 25 }}>QUANTIDADES DE LITROS GASTOS DE COMBUSTIVEL</Text>
                        <View style={stylesButtons.CarroMoto}>

                            <Text style={{ fontSize: 25 }}> {litros.toFixed(2)} LITROS</Text>
                        </View>
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 20 , marginBottom:10}}> VALOR DO LITRO DO ETANOL</Text>
                        <TextInput
                        ...
                        <Text style={{ fontSize: 20 , marginBottom:10}}> QUILOMETOR POR LITRO DE ETANOL</Text>
                        <TextInput
                            style={stylesButtons.CarroMoto}
                            placeholder="10 KM/L"
                            keyboardType="numeric"
